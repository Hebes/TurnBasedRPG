...
public class UIAutomationTool : EditorWindow
{
    ...
    private void CreatConfig()
    {
        ...
        FindComponentDemo.CreatCSharpScript(obj, ComponentsDic);
    }
    ...
    private void PrintConfig()
    {
        ...
        GameObject obj = Selection.objects.First() as GameObject;
        Dictionary<string, List<Component>> ComponentsDic = FindComponentDemo.FindComponents(obj);
        FindComponentDemo.DebugOutDemo(ComponentsDic, true);
    }
    ...
    private void AddListener()
    {
        ...
        GameObject obj = Selection.objects.First() as GameObject;
        Dictionary<string, List<Component>> ComponentsDic = FindComponentDemo.FindComponents(obj);
        FindComponentDemo.DebugOutAddListenerDemo(InputComponentName, ComponentsDic);
    }
