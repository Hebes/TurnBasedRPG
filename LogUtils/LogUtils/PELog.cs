...
public static class ExtensionMethonds
{
    ...
    {
        LogUtils.PELog.Log(string.Format(Log, args));
    }
    /// <summary>
    /// 打印日志
    /// </summary>
    ...
    {
        LogUtils.PELog.Log(logCoLorEnum, string.Format(Log, args));
    }
    /// <summary>
    /// 打印带有颜色的日志
    /// </summary>
    ...
    {
        LogUtils.PELog.Log(logCoLorEnum,Log);
    }
    ...
    {
        LogUtils.PELog.Trace(string.Format(Log, args));
    }
    /// <summary>
    /// 打印堆栈
    /// </summary>
    ...
    {
        LogUtils.PELog.Warn(string.Format(Log, args));
    }
    /// <summary>
    /// 打印警告日志
    /// </summary>
    ...
    {
        LogUtils.PELog.Error(string.Format(Log, args));
    }
    /// <summary>
    /// 打印错误日志
    /// </summary>
...
namespace LogUtils
{
    ...
    public class PELog
    {
        ...
        {
            //反射获取Unity的日志输出系统
            Type type = Type.GetType("UnityEngine.Debg , UnityEngine ");
        ...
        {
            cfg = PELog.cfg = cfg == null ? new LogConfig() : cfg;
            switch (PELog.cfg.eLoggerType)
            {
